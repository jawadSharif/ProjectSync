...
namespace MyCompany.DevOpsProject
{
    public class DevOpsAppService : MyCompanyAppServiceBase, IDevOpsAppService
    {
        ...
        public async Task<Tuple<string>> AccessToken(string input)
        {
        ...
        public async Task<List<WorkItemDetail>> GetProjectWorkItems(GetWorkItemsInput input)
        {
            var query = JsonConvert.SerializeObject(new WorkItemQuery() { query = "Select [System.Title] From WorkItems order by [System.CreatedDate] desc" });
            ...
            var url = $"https://dev.azure.com/{input.Organization}/{input.Project}/_apis/wit/wiql?api-version={input.Version}";
            ...
            */
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                var workItemDetail = JsonConvert.DeserializeObject<WorkItemDetailRoot>(stringworkItemsData);
