...
@Injectable()
export class AsanaServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getAsanaWorkSpaces(token: string | null | undefined): Observable<StringStringKeyValuePair[]> {
        let url_ = this.baseUrl + "/api/services/app/Asana/GetAsanaWorkSpaces?";
        if (token !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAsanaWorkSpaces(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAsanaWorkSpaces(<any>response_);
                } catch (e) {
    ...
    protected processGetAsanaWorkSpaces(response: HttpResponseBase): Observable<StringStringKeyValuePair[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAllProjectInWorkSpace(workspaceId: string | null | undefined, token: string | null | undefined): Observable<StringStringKeyValuePair[]> {
        let url_ = this.baseUrl + "/api/services/app/Asana/GetAllProjectInWorkSpace?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllProjectInWorkSpace(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllProjectInWorkSpace(<any>response_);
                } catch (e) {
                    return <Observable<StringStringKeyValuePair[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetAllProjectInWorkSpace(response: HttpResponseBase): Observable<StringStringKeyValuePair[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAllTasksInProject(projectId: string | null | undefined, token: string | null | undefined): Observable<StringStringKeyValuePair[]> {
        let url_ = this.baseUrl + "/api/services/app/Asana/GetAllTasksInProject?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllTasksInProject(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllTasksInProject(<any>response_);
                } catch (e) {
                    return <Observable<StringStringKeyValuePair[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetAllTasksInProject(response: HttpResponseBase): Observable<StringStringKeyValuePair[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    createTaskInProject(body: CreateTaskDtoRoot | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Asana/CreateTaskInProject";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateTaskInProject(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateTaskInProject(<any>response_);
                } catch (e) {
    ...
    protected processCreateTaskInProject(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class DevOpsServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    accessToken(input: string | null | undefined): Observable<StringTuple> {
        let url_ = this.baseUrl + "/api/services/app/DevOps/AccessToken?";
        if (input !== undefined)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAccessToken(<any>response_);
                } catch (e) {
                    return <Observable<StringTuple>><any>_observableThrow(e);
                }
            } else
                return <Observable<StringTuple>><any>_observableThrow(response_);
        }));
    }

    protected processAccessToken(response: HttpResponseBase): Observable<StringTuple> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = StringTuple.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<StringTuple>(<any>null);
    }
     ...
     * @return Success
     */
    getProjects(organization: string | null | undefined, token: string | null | undefined, version: string | null | undefined): Observable<StringStringKeyValuePair[]> {
        let url_ = this.baseUrl + "/api/services/app/DevOps/GetProjects?";
    ...
    protected processGetProjects(response: HttpResponseBase): Observable<StringStringKeyValuePair[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getProjectWorkItems(organization: string | null | undefined, project: string | null | undefined, token: string | null | undefined, version: string | null | undefined): Observable<WorkItemDetail[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetProjectWorkItems(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
     ...
     * @return Success
     */
    createTask(body: CreateDevOpsTaskDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/DevOps/CreateTask";
        url_ = url_.replace(/[?&]$/, "");
...
export class CreateTaskDtoInput implements ICreateTaskDtoInput {
    name: string | undefined;
    notes: string | undefined;
    projects: string[] | undefined;
    workspace: string | undefined;

    constructor(data?: ICreateTaskDtoInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateTaskDtoInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateTaskDtoInput();
        result.init(data);
        return result;
    }
...
export interface ICreateTaskDtoInput {
    name: string | undefined;
    notes: string | undefined;
    projects: string[] | undefined;
    workspace: string | undefined;
...
export class CreateTaskDto implements ICreateTaskDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.data = _data["data"] ? CreateTaskDtoInput.fromJS(_data["data"]) : <any>undefined;
        }
    }
...
export class CreateTaskDtoRoot implements ICreateTaskDtoRoot {
    task: CreateTaskDto;
    token: string | undefined;

    constructor(data?: ICreateTaskDtoRoot) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.task = _data["task"] ? CreateTaskDto.fromJS(_data["task"]) : <any>undefined;
            this.token = _data["token"];
        }
    }

    static fromJS(data: any): CreateTaskDtoRoot {
        data = typeof data === 'object' ? data : {};
        let result = new CreateTaskDtoRoot();
        result.init(data);
        return result;
    }
...
export interface ICreateTaskDtoRoot {
    task: CreateTaskDto;
    token: string | undefined;
}
...
export class StringTuple implements IStringTuple {
    readonly item1: string | undefined;

    constructor(data?: IStringTuple) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): StringTuple {
        data = typeof data === 'object' ? data : {};
        let result = new StringTuple();
        result.init(data);
        return result;
    }
...
export class CreateDevOpsTaskBodyDto implements ICreateDevOpsTaskBodyDto {
    op: string | undefined;
    path: string | undefined;
    from: string | undefined;
    value: string | undefined;

    constructor(data?: ICreateDevOpsTaskBodyDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateDevOpsTaskBodyDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateDevOpsTaskBodyDto();
        result.init(data);
        return result;
    }
...
export interface ICreateDevOpsTaskBodyDto {
    op: string | undefined;
    path: string | undefined;
    from: string | undefined;
    value: string | undefined;
...
export class CreateDevOpsTaskDto implements ICreateDevOpsTaskDto {
    ...
    constructor(data?: ICreateDevOpsTaskDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["data"])) {
                ...
                for (let item of _data["data"])
                    this.data.push(CreateDevOpsTaskBodyDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): CreateDevOpsTaskDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateDevOpsTaskDto();
        result.init(data);
        return result;
    }
...
export interface ICreateDevOpsTaskDto {
    organization: string | undefined;
    project: string | undefined;
    version: string | undefined;
    token: string | undefined;
...
export class CreateProjectDto implements ICreateProjectDto {
    devOpsAccessToken: string | undefined;
    ...
    asanaProjectName: string | undefined;
    shouldCreateAsanaTask: boolean;
    ...
    init(_data?: any) {
        if (_data) {
            this.devOpsAccessToken = _data["devOpsAccessToken"];
            this.devOpsOrganization = _data["devOpsOrganization"];
            this.devOpsProject = _data["devOpsProject"];
            this.asanaToken = _data["asanaToken"];
            this.asanaWorkSpace = _data["asanaWorkSpace"];
            this.asanaProjectId = _data["asanaProjectId"];
            this.asanaProjectName = _data["asanaProjectName"];
            this.shouldCreateAsanaTask = _data["shouldCreateAsanaTask"];
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["devOpsAccessToken"] = this.devOpsAccessToken;
        data["devOpsOrganization"] = this.devOpsOrganization;
        data["devOpsProject"] = this.devOpsProject;
        data["asanaToken"] = this.asanaToken;
        data["asanaWorkSpace"] = this.asanaWorkSpace;
        data["asanaProjectId"] = this.asanaProjectId;
        data["asanaProjectName"] = this.asanaProjectName;
        data["shouldCreateAsanaTask"] = this.shouldCreateAsanaTask;
        return data; 
    }
